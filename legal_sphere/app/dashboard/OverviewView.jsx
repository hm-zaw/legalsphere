...
export default function OverviewView({ onNavigate }) {
  ...
  // Internal Tabs for the "Active File" card
  ...
  useEffect(() => {
    ...
    fetchUserCases();
  }, []); // Re-run if user changes or to refresh
  ...
  const getStatusColor = (status) => {
    const statusColors = {
      ...
      'Pending Submission': 'text-slate-600 bg-slate-50 border-slate-200',
      'submitted': 'text-blue-700 bg-blue-50 border-blue-200',
      'Submitted': 'text-blue-700 bg-blue-50 border-blue-200',
      'ai_analysis': 'text-amber-700 bg-amber-50 border-amber-200',
      'Ai Analysis': 'text-amber-700 bg-amber-50 border-amber-200',
      'analysis_completed': 'text-indigo-700 bg-indigo-50 border-indigo-200',
      'Analysis Completed': 'text-indigo-700 bg-indigo-50 border-indigo-200',
      'lawyer_assigned': 'text-green-700 bg-green-50 border-green-200',
      'Lawyer Assigned': 'text-green-700 bg-green-50 border-green-200',
  ...
  return (
    <div className="w-full h-full overflow-y-auto bg-[#efefec]">
          {/* --- Top Navigation Bar --- */}
               ...
               <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 p-10 lg:p-14 items-center">
                  <div className="space-y-8">
                    ...
                    <div className="flex flex-wrap gap-4">
                        <button onClick={() => onNavigate("apply-new")} className="bg-[#af9164] text-white px-8 py-3.5 rounded-lg text-sm font-bold uppercase tracking-widest hover:bg-[#9c7f56] transition-all shadow-lg hover:shadow-[#af9164]/20 flex items-center gap-3">
                            <Plus className="w-4 h-4" /> Start New Filing
                        </button>
                        <button onClick={() => onNavigate("my-cases")} className="px-8 py-3.5 rounded-lg text-sm font-bold uppercase tracking-widest border border-white/20 hover:bg-white/5 transition-all text-white flex items-center gap-3">
